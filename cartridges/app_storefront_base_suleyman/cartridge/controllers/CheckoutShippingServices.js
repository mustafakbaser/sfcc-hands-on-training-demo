...
server.post(
    ...
    function (req, res, next) {
        ...
        if (Object.keys(shippingFormErrors).length > 0) {
            ...
            // <Task 9> nickname has been added
            result.address = {
                ...
                nickname: form.shippingAddress.addressFields.nickname.value
            };
            ...
            this.on('route:BeforeComplete', function (req, res) { // eslint-disable-line no-shadow
                ...
                var basketModel = new OrderModel(
                    currentBasket,
                    {
                        nickname: result.address.nickname,
                ...
                // <Task 9>
                Transaction.wrap(function () {
                    currentBasket.custom.customerNickname = result.address.nickname;
                });
                // </Task 9>
