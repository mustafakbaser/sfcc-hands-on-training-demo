...
server.get(
    ...
    function (req, res, next) {
            ...
            if (accountModel.registeredUser) {
                ...
                if (!requestStage) {
                    Transaction.wrap(function () {
                        ...
                        currentBasket.custom.customerNickname = accountModel.profile.nickname;
                        //orderModel.custom.nickname = accountModel.profile.nickname;
                    });
                }
        ...
        res.render('checkout/checkout', {
            ...
            basketNickname: currentBasket.custom.customerNickname,
