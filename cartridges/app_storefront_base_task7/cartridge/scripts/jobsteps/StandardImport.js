...
function genericImport(args, callback) {
    ...
    var filesToImport;
    var importFolder = File.IMPEX + FileHelper.prependSeparator(StepUtil.replacePathPlaceholders(args.SourceFolder));

    try {
        // Check source directory
        filesToImport = FileHelper.getFiles(importFolder, args.FilePattern);
    } catch (e) {
